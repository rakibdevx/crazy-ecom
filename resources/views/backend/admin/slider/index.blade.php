        ...
        <div class="row g-3 justify-content-between">
            <div class="col-auto">
                <div class="position-relative">
                    <input class="form-control px-5" type="search" id="customSearch" placeholder="Search Sliders">
            ...
            @can('Slider-create')
                <div class="col-auto">
                    <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                        <a href="{{route('admin.sliders.create')}}" class="btn btn-primary px-4"><i class="bi bi-plus-lg me-2"></i>Add Slider</a>
                    </div>
                </div>
            @endcan
        </div><!--end row-->
    ...
    <script>
        var table = $('#data').DataTable({
            ...
            columns: [
                ...
                { data: 'link', name: 'link' , responsivePriority: 1},
                { data: 'status', name: 'status' , responsivePriority: 1},
                { data: 'sort_order', name: 'sort_order' , responsivePriority: 1},
