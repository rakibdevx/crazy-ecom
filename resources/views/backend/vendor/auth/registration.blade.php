...
<div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex border-end">
    ...
    <div class="card rounded-0 mb-0 border-0 shadow-none bg-transparent">
        <div class="card-body">
        <img src="{{asset(setting('registration_background'))}}" class="img-fluid auth-img-cover-login" width="650" alt="">
        </div>
    </div>
...
<div class="col-12 col-xl-5 col-xxl-4 auth-cover-righ d-flex align-items-center justify-content-center">
    <div class="card rounded-0 m-3 mb-0 border-0 shadow-none">
        <div class="card-body p-sm-5">
            ...
            <h4 class="fw-bold">Get Started Now As A Seller</h4>
            ...
            <div class="form-body mt-4">
                <form class="row g-3" action="{{ route('vendor.registration.submit') }}" method="POST">
                    @csrf
                    <div class="col-12">
                        <label for="inputNameAddress" class="form-label">Name</label>
                        <input type="text" name="name"
                               class="form-control @error('name') is-invalid @enderror"
                               id="inputNameAddress" placeholder="jhon@example.com"
                               value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div class="col-12">
                        <div class="form-check form-switch">
                            <input class="form-check-input  @error('checkbox') is-invalid @enderror" name="checkbox" type="checkbox" id="flexSwitchCheckChecked">
                    ...
                    <div class="col-12">
                        <div class="text-start">
                            <p class="mb-0">Already have an account? <a href="{{route('vendor.login')}}">Sign in here</a></p>
                        </div>
                    </div>
                </form>
            </div>
