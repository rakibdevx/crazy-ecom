        ...
        <div class="row g-3 justify-content-between">
            <div class="col-auto">
                <div class="position-relative">
                    <input class="form-control px-5" type="search" id="customSearch" placeholder="Search Shipping Zone">
            ...
            @can('Shipping-zone-create')
                <div class="col-auto">
                    <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                        <a href="{{route('admin.shipping_zone.create')}}" class="btn btn-primary px-4"><i class="bi bi-plus-lg me-2"></i>Add Shipping zone</a>
                    </div>
                </div>
            @endcan
        </div><!--end row-->
...
@push('js')
    ...
    <script>
        var table = $('#data').DataTable({
            ...
            responsive: true,
            ajax: {
                url: '{{ route('admin.shipping_zone.index') }}',
                data: function (d) {
        ...
        function deleteshippingZone(url) {
            Swal.fire({
                title: 'Are you sure?',
