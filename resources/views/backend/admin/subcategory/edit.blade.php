                            ...
                            <form action="{{ route('admin.sub_category.update', $sub_category->id) }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-control @error('status') is-invalid @enderror" required>
                                        ...
                                        <option value="inactive" {{ old('status', $sub_category->status) == 'inactive' ? 'selected' : '' }}>In Active</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($sub_category->image)
                                        <img src="{{asset($sub_category->image)}}" height="100px" width="auto" alt="{{$sub_category->name}}">
                                    @endif
                                </div>
