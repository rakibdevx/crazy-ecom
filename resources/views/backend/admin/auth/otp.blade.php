...
<div class="col-12 col-xl-5 col-xxl-4 auth-cover-righ d-flex align-items-center justify-content-center">
    <div class="card rounded-0 m-3 mb-0 border-0 shadow-none">
        <div class="card-body p-sm-5">
            ...
            <div class="form-body">
                <form class="row g-3" action="{{ route('admin.otp.verify') }}" method="POST">
                    @csrf
                    ...
                    <div class="col-12 text-end">
                        <a href="{{ route('admin.resendOtp',$email) }}" class="text-decoration-none small text-primary">Resend Code</a>
                    </div>
