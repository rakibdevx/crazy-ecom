...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    public function makePayment(array $requestData, $type = 'checkout', $pattern = 'json')
    {
        ...
        $response = $this->callToApi($this->data, $header, $this->config['connect_from_localhost'] = true);
    ...
    {
        $this->successUrl = rtrim(env('APP_URL'), '/').'/'.'ssl'. $this->config['success_url'];
    }
    ...
    {
        $this->failedUrl = rtrim(env('APP_URL'), '/').'/'.'ssl'.$this->config['failed_url'];
    }
    ...
    {
        $this->cancelUrl =rtrim(env('APP_URL'), '/').'/'.'ssl'. $this->config['cancel_url'];
    }
    ...
    {
        $this->ipnUrl = rtrim(env('APP_URL'), '/').'/'.'ssl'. $this->config['ipn_url'];
    }
