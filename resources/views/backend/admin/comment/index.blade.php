        ...
        <div class="row g-3 justify-content-between">
            <div class="col-auto">
                <div class="position-relative">
                    <input class="form-control px-5" type="search" id="customSearch" placeholder="Search Comment">
    ...
    <script>
        var table = $('#data').DataTable({
            ...
            columns: [
                ...
                { data: 'product', name: 'product' , responsivePriority: 1},
                { data: 'user', name: 'user' , responsivePriority: 1},
                { data: 'rating', name: 'rating' , responsivePriority: 1},
