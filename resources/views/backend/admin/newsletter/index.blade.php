        ...
        <div class="row g-3 justify-content-between">
            <div class="col-auto">
                <div class="position-relative">
                    <input class="form-control px-5" type="search" id="customSearch" placeholder="Search Email">
    ...
    <script>
        var table = $('#data').DataTable({
            ...
            columns: [
                ...
                { data: 'subscribe_time', name: 'subscribe_time' , responsivePriority: 1},
