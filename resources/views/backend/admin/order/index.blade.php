...
<div class="main-content">
    ...
    <!--end breadcrumb-->
        <div class="product-count d-flex align-items-center gap-3 gap-lg-4 mb-4 fw-bold flex-wrap font-text1">
            ...
            <a href="javascript:;"><span class="me-1">Delivered</span><span class="text-secondary">({{$delivered}})</span></a>
        </div>

        <div class="row g-3 justify-content-between">
            <div class="col-auto">
                <div class="position-relative">
                    <input class="form-control px-5" type="search" id="customSearch" placeholder="Search Order">
    ...
    <script>
        var table = $('#data').DataTable({
            ...
            columns: [
                ...
                { data: 'grand_total', name: 'grand_total', orderable: false, searchable: false, responsivePriority: 2 },
                { data: 'status', name: 'status', orderable: false, searchable: false, responsivePriority: 2 },
                { data: 'payment_status', name: 'payment_status', orderable: false, searchable: false, responsivePriority: 2 },
                { data: 'placed_at', name: 'placed_at', orderable: false, searchable: false, responsivePriority: 3 },
