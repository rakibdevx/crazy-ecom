...
class OrderController extends Controller
{
    ...
    public function pending()
    {
        ...
        $query = Order::where('order_status','pending')->select('id','order_number','user_id','grand_total','order_status','payment_status','placed_at')->latest();
        if (request()->has('search')) {
            $search = request()->search;
            $query->where(function($q) use ($search) {
                $q->where('name', 'like', '%'.$search.'%')
    ...
    public function processing()
    {
        ...
        $query = Order::where('order_status','processing')->select('id','order_number','user_id','grand_total','order_status','payment_status','placed_at')->latest();
        if (request()->has('search')) {
            $search = request()->search;
            $query->where(function($q) use ($search) {
                $q->where('name', 'like', '%'.$search.'%')
    ...
    public function shipped()
    {
        ...
        $query = Order::where('order_status','shipped')->select('id','order_number','user_id','grand_total','order_status','payment_status','placed_at')->latest();
        if (request()->has('search')) {
            $search = request()->search;
            $query->where(function($q) use ($search) {
                $q->where('name', 'like', '%'.$search.'%')
    ...
    public function delivered()
    {
        ...
        $query = Order::where('order_status','delivered')->select('id','order_number','user_id','grand_total','order_status','payment_status','placed_at')->latest();
        if (request()->has('search')) {
            $search = request()->search;
            $query->where(function($q) use ($search) {
                $q->where('name', 'like', '%'.$search.'%')
    ...
    public function cancelled()
    {
        ...
        $query = Order::where('order_status','cancelled')->select('id','order_number','user_id','grand_total','order_status','payment_status','placed_at')->latest();
        if (request()->has('search')) {
            $search = request()->search;
            $query->where(function($q) use ($search) {
                $q->where('name', 'like', '%'.$search.'%')
    ...
    public function ceturned()
    {

        $query = Order::where('order_status','ceturned')->select('id','order_number','user_id','grand_total','order_status','payment_status','placed_at')->latest();
        if (request()->has('search')) {
            $search = request()->search;
            $query->where(function($q) use ($search) {
                $q->where('name', 'like', '%'.$search.'%')
