...
<div class="main-content">
    <!--breadcrumb-->
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{route('admin.user.index')}}" class="btn btn-primary px-4"><i class="bx bx-left-arrow-circle"></i>Back</a>
                </div>
            </div>
        </div>
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="position-relative">
                                        <img src="{{$user->banner_image?asset($user->banner_image):asset(setting('default_profile_banner'))}}" class="img-fluid rounded" alt="">
                                        <div class="position-absolute top-100 start-50 translate-middle">
                                            <img src="{{$user->profile_image?asset($user->profile_image):asset(setting('default_profile_image'))}}" width="100" height="100"
