    ...
    <!--breadcrumb-->
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card mt-4">
                    <div class="card-body">
                        <form action="{{ route('admin.vendor.store') }}" method="POST" class="row g-3 needs-validation">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <select name="verified" class="form-control @error('verified') is-invalid @enderror" required>
                                    <option value="0" {{ old('verified') }}>Disabled</option>
                                    <option value="1" {{ old('verified') }}>Enabled</option>
                                </select>
