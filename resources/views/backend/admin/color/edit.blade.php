        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{$color->name}}</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{ route('admin.color.index') }}" class="btn btn-primary px-4">
    ...
    <div class="row">
        <div class="col-md-6 col-xl-6 d-flex">
            <div class="card w-100 rounded-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.color.update', $color->id) }}" method="POST" class="row g-3 needs-validation">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="colorCode" name="code"
                                    class="form-control"
